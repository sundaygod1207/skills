...
echo "3. 获取你的用户 ID：lark-cli auth status"
echo "4. 编辑配置文件，替换 USER_ID 为你的用户 ID："
echo "   nano $LARK_DIR/feishu-poller.py"
echo "5. 启动轮询：python3 $LARK_DIR/feishu-poller.py"
echo ""
